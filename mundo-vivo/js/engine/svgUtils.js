...
(function (PMV) {
  ...
  // Balanço vertical (bob) via SMIL translate — mesmo princípio do
  // addSway, mas deslocando em vez de rotacionar. Usado por peixes e
  // outras criaturas que sobem/descem sutilmente enquanto se movem.
  function addBob(target, { amplitude = 4, dur = 3, begin = 0 } = {}) {
    const anim = createSvgEl('animateTransform', {
      attributeName: 'transform',
      type: 'translate',
