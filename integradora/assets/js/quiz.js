...
(function () {
  ...
  // Carrega os filtros vindos da página de filtros.
  var saved = null;
  ...
  // Consome os filtros (uso único): assim, ao reabrir/atualizar/restaurar o
  // quiz.html, ele não cai direto no quiz — volta para a página de filtros.
  // O treino segue rodando a partir da cópia em memória (variável saved).
